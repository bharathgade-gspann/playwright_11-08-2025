...
await page.getByPlaceholder('Name').fill("GadeBharath")
await page.getByPlaceholder('Email').fill("bharathgade82@gmail.com")
await page.getByPlaceholder('Password').fill("Bharath@123")
...
await dropdwon.selectOption({value:'Telangana'})
